<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="amp_access.Product.Default" %>
<!--
...
<body>
  ...
  <div id="container">
    ...
    <amp-carousel type="slides" layout="fixed-height" height=250 id="carousel"
                  ...
                  on="slideTap:AMP.setState({selected: {slide: event.index}})">
    ...
    <input type="text" id="txtAAA" [value]="selected.slide" />

    <!-- TODO: "슬라이드 표시기 추가" -->
    <p class="dots">
        <!-- 현재 표시된 슬라이드에 해당하는 <span> 요소에는 'current' CSS 클래스가 있습니다. -->
    ...
    <form method="post" action-xhr="/shirts/addToCart" target="_top">
      ...
      <div class="options price">
          <h6>PRICE :
              ...
              <span name="abc" [text]="shirts[selected.sku].sizes[selectedSize] || '---'">---</span>
          </h6>
      </div>
     ...
     "option" 속성 값으로 설정합니다.  -->
      ...
      <div submit-success>
        <template type="amp-mustache">Hello {{quantity}} sdfasdfasdfasdf </template>
